...
### 기본 정보 
기본 정보를 설정합니다.
![CDN서비스생성-기본정보](https://static.toastoven.net/prod_cdn/v2/console-cdn-create-default2_20210525.png)
...
![CDN서비스생성-기본정보](https://static.toastoven.net/prod_cdn/v2/console-cdn-create-origin2_20210525.png)
...
![CDN서비스생성-캐시](https://static.toastoven.net/prod_cdn/v2/console-cdn-create-cache2_20210525.png)
...
![CDN서비스생성-Auth Token 인증 접근 관리](https://static.toastoven.net/prod_cdn/v2/console-cdn-create-auth-token_20210525.png)
...
![CDN서비스수정활성화](https://static.toastoven.net/prod_cdn/v2/console-cdn-modify3_20210525.png)

1. 변경할 CDN 서비스를 CDN 서비스 목록에서 선택합니다.
2. 화면 아래 **설정** 탭의 **수정** 버튼을 클릭합니다.

다음과 같이 변경할 수 있는 항목이 활성화됩니다.
![CDN서비스수정확인](https://static.toastoven.net/prod_cdn/v2/console-cdn-modify2_20210525.png)
...
2. **일시 정지** 버튼을 클릭합니다.
![CDN서비스-일시정지](https://static.toastoven.net/prod_cdn/v2/console-cdn-pause2_20210525.png)
3. 인증서가 연동된 CDN 서비스에는 인증서 만료 경고 안내가 표시됩니다. 인증서가 만료되지 않게 하려면 인증서 갱신 시작일 이전에 CDN 서비스를 재시작해야 합니다.
![CDN서비스-일시정지](https://static.toastoven.net/prod_cdn/v2/console-cdn-restart2_20210525.png)
...
2. **삭제** 버튼을 클릭합니다.
![CDN서비스-삭제](https://static.toastoven.net/prod_cdn/v2/console-cdn-delete2_20210525.png)
...
2. **캐시 재배포** 탭을 클릭합니다.
![CDN캐시재배포](https://static.toastoven.net/prod_cdn/v2/console-cdn-purge2_20210525.png)
...
![CDN신규인증서발급](https://static.toastoven.net/prod_cdn/v2/console-certificate-create_20210525.png)
...
![CDN도메인검증](https://static.toastoven.net/prod_cdn/v2/console-certificate-domain-validation_20210525.png)
...
![CDN도메인검증](https://static.toastoven.net/prod_cdn/v2/console-certificate-domain-validation2_20210525.png)
...
![CDN도메인검증](https://static.toastoven.net/prod_cdn/v2/console-certificate-domain-validation-dns_20210525.png)
...
다음 화면은 NHN Cloud DNS+ 서비스에서 설정한 예시입니다. DNS 서비스 제공 업체에 따라 설정 방법은 다를 수 있습니다.
![CDN서비스연동-CNAME위임](https://static.toastoven.net/prod_cdn/v2/console-certificate-service-cname_20210525.png)
...
![CDN서비스연동-도메인별칭](https://static.toastoven.net/prod_cdn/v2/console-certificate-service-alias2_20210525.png)
...
![CDN인증서정상상태](https://static.toastoven.net/prod_cdn/v2/console-certificate-active_20210525.png)
...
![cdn_08_201812](https://static.toastoven.net/prod_cdn/cdn_08_20210525.png)
