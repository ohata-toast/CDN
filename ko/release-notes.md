...
#### 기능 개선/변경
* CDN서비스에 HTTP/2 프로토콜 지원을 활성화하였습니다. 기본 설정으로 HTTP/2가 지원됩니다.
* 원본 타입 설정 기능 추가
	* NHN Cloud의 Object Storage와 인스턴스 정보를 조회하여 원본 서버로 설정할 수 있습니다. 자세한 내용은 [콘솔 가이드 > 원본 서버](./console-guide/#_2)를 참고하시기 바랍니다.
