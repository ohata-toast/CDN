...
| 21000     | OpenStack Api fail.| 기본 인프라 서비스 정보 조회에 실패하였습니다. 잠시 후 시도해 주세요. |
| 21002     | Get iaas token fail.| 기본 인프라 서비스 토큰 발급에 실패하였습니다. 잠시 후 시도해 주세요. |
| 21003     | IaaS not enabled.| 기본 인프라 서비스가 활성화되어있지 않습니다. 기본 인프라 서비스를 활성화한 후에 원본 타입에서 인스턴스 목록을 검색할 수 있습니다.|
| 21004     | Object storage not enabled.| Object Storage 서비스가 활성화되어있지 않습니다. Object Storage 서비스를 활성화 한 후에 원본 타입에서 오브젝트 스토리지를 검색할 수 있습니다.|
