...
![CDNサービス作成-キャッシュ](https://static.toastoven.net/prod_cdn/v2/console-cdn-create-cache2_202111.png)
...
> 2. Windows OS設定変更参考ガイド：[リンク](https://cert.crosscert.com/Windowswindows-OS-pcで-ルート証明書-インストール方法/)
